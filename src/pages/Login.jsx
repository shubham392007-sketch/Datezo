      ...
      <main className="flex-grow py-16 px-4 md:px-8 flex items-center justify-center">
        <StickerCard className="max-w-md w-full p-8 sm:p-10 space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-3xl font-black text-ink">Log In to Datezo</h1>
            <p className="text-xs text-body font-medium">Access your saved compatibility reports and match history.</p>
          </div>
          ...
          <div className="text-center text-xs text-body pt-2 border-t border-black/10">
            ...
            <Link to="/signup" className="text-coral font-bold underline">
              Create Account
            </Link>
          </div>
        </StickerCard>
